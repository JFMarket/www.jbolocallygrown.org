...
class Agnosia_Bootstrap_Carousel {
	...
	private function get_control() {
		extract( $this->attributes );
		$output = '<a class="carousel-control left" href="#' . $name . '" data-slide="prev"><span class="icon-prev"></span></a>';
		$output .= '<a class="carousel-control right" href="#' . $name . '" data-slide="next"><span class="icon-next"></span></a>';
